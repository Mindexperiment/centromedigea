<div class="py-8 px-6">
    ...
    <div class="clearfix mb-6 p-6">
        <div class="w-32 float-right ml-4 my-2">
            @include('svg.yellow-fish')
        </div>
    ...
    <div class="flex items-center">
        ...
        <div class="w-full sm:w-3/5 sm:pl-2">
            <p class="mb-2">Per la Dott.ssa Monica (<a href="{{ route('partners.pedodonzia') }}" title="Profilo di Monica Pozza" class="underline text-blue-600">#monica</a>) lavorare con i più piccoli è una vera e propria vocazione.</p>
