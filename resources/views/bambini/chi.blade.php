<div class="py-8 px-6">
    ...
    <div class="clearfix mb-6 p-6">
        <img src="{{ asset('images/layout/yellow-fish.svg') }}" alt="Un pesce di colore giallo" class="w-32 float-right ml-4 my-2" />
    ...
    <div class="flex items-center">
        <div class="hidden sm:block sm:w-2/5 pr-2">
            <img src="{{ asset('images/partners/pedodonzia/bambini.jpg') }}" alt="La dottoressa Monica assieme ad una paziente ed il suo bambino" class="border-4 border-teal-400 rounded-full shadow-md" />
        </div>
        ...
        <div class="w-full sm:w-3/5 sm:pl-2">
            ...
            <p class="mb-4">La nostra dottoressa e tutto il personale di assistenza si è dedicato alla <strong>formazione nel campo pediatrico</strong> per cui le attività, i giochi che vengono proposti prima e durante la seduta sono sempre frutto di <u>tecniche studiate per guadagnare la fiducia del piccolo paziente</u>, niente viene fatto con superficialità.</p>
